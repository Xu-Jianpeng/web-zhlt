            ...
            <div class="header-main">
                ...
                <!-- <div class="header-text"> -->
                    <div class="dropdown" style="float: right;line-height:60px;">
                        <button type="button" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" style="background-color: lightblue;"><img src="../images/homepage/user.png" height=20px>
                        ...
                        if($_SESSION['username']!=""&&$_SESSION['username']!="root"){
                            ...
                            <li role="presentation">
                                <a role="menuitem" tabindex="-1" href="../selfpage.php">个人主页</a>
                            </li>
                            <li role="presentation">
                                <a role="menuitem" tabindex="-1" href="../usercenter.php">更改账号信息</a>
                            </li>
                            <li role="presentation">
                                <a role="menuitem" tabindex="-1" href="../changeuserpwd.php">修改密码</a>
                            </li>
                            <li role="presentation">
                            ...
                            echo '<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                            <li role="presentation">
                                <a role="menuitem" tabindex="-1" href="../admin/backstage.php">返回后台</a>
                            </li>
                            <li role="presentation" class="divider"></li>
                            <li role="presentation">
                                <a role="menuitem" tabindex="-1" href="../article/publish.php">发布文章</a>
