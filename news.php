...
$sql = "select * from publish where category='新闻' or category='news' order by id asc";
$res = $con->query($sql);
        ...
        <?php for ($j = 0; $j < mysqli_num_rows($res); $j++) { ?>
            <tr>
                <td style="width:700px">
                    <form action="model.php" name=formn<?echo $j?> method="get">
                        <a href="javascript:formn<?echo $j?>.submit();">
