      ...
      <tr>
        <td>
          <table width="400" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
              <td>
                <form name="form2" method="post" action="editcomment.php">
          ...
          <table width="1050" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#999999">
            <tr bgcolor="#f0f0f0" height="50px">
              <td width="25%" style="text-align:center">评论内容</td>
            ...
            <form name="form3" method="post" action="deletecomment.php">
              <?php
              $conn = mysqli_connect("localhost", 'abc', '11111111', 'zhlt') or die("数据库服务器连接错误");
              mysqli_query($conn, "set names utf8");
              $keyword = $_POST["find"];
              // echo $keyword;
              $sql = "select * from comment where content like '%$keyword%' order by id desc";
              $res = $conn->query($sql);
              ...
              <table width="1100" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
                <td width="92">
                  <div style="float:right;margin-right:50"><input type="submit" name="submit" value="删除选项" onclick="javascript:return confirm('您确认要删除评论吗？');">
                  </div>
                </td>
      </tr>
