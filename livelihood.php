<?php
    ...
    $sql="select * from publish where category='民生' or category='livelihood' order by id asc";
    $res=$con->query($sql);
        ...
        <table style="margin-left:200px;font-size:20px">
            <?php for($j=0;$j<mysqli_num_rows($res);$j++){?>
                <tr>
                    ...
                    <form action="model.php" name=formli<?echo $j?> method="get">
                        <a href="javascript:formli<?echo $j?>.submit();">
