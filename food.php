...
$sql = "select * from publish where category='美食' or category='food' order by id asc";
$res = $con->query($sql);
        ...
        <?php for ($j = 0; $j < mysqli_num_rows($res); $j++) { ?>
            <tr>
                <td style="width:700px">
                    <form action="model.php" name=formf<?echo $j?> method="get">
                        <a href="javascript:formf<?echo $j?>.submit();">
            ...
            <tr style="height: 50px;">
                <td>
                <a href="javascript:form<?echo $j?>.submit();">
                    <?php 
                    $aa = $row3[$j];
