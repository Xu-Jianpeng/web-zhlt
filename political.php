<?php
    ...
    $sql="select * from publish where category='时政' or category='political' order by id asc";
    $res=$con->query($sql);
        ...
        <table style="margin-left:200px;font-size:20px">
            <?php for($j=0;$j<mysqli_num_rows($res);$j++){?>
                <tr>
                    ...
                    <form action="model.php" name=formpo<?echo $j?> method="get">
                        <a href="javascript:formpo<?echo $j?>.submit();">
